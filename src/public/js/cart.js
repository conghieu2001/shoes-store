...
function addTocartCicked(e){
    ...
    const buttonAddProduct = e.target.parentElement.parentElement.parentElement;
    // console.log(buttonAddProduct);
    var NewProduct={
              id: buttonAddProduct.getElementsByClassName('item-id')[0].innerText,
              name: buttonAddProduct.getElementsByClassName('item-name-db')[0].innerText,
              description: buttonAddProduct.getElementsByClassName('item-name')[0].innerText,
              image: buttonAddProduct.getElementsByClassName('item-img')[0].src,
              price: buttonAddProduct.getElementsByClassName('item-price')[0].innerText,
              loai: buttonAddProduct.getElementsByClassName('item-loai')[0].innerText,
              quantity :1
    }
